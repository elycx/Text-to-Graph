...
\node[graphnode] (n_A0) at (-0.82,1.72) {$A_{0}$};
\node[graphnode] (n_A1) at (1.71,1.72) {$A_{1}$};
\node[graphnode] (n_A2) at (4.24,1.72) {$A_{2}$};
\node[graphnode] (n_A3) at (6.76,1.72) {$A_{3}$};
\node[graphnode] (n_A4) at (9.29,1.72) {$A_{4}$};
\node[graphnode] (n_A5) at (11.82,1.72) {$A_{5}$};
\node[graphnode] (n_B0) at (-0.82,-1.72) {$B_{0}$};
\node[graphnode] (n_B1) at (1.71,-1.72) {$B_{1}$};
\node[graphnode] (n_B2) at (4.24,-1.72) {$B_{2}$};
\node[graphnode] (n_B3) at (6.76,-1.72) {$B_{3}$};
\node[graphnode] (n_B4) at (9.29,-1.72) {$B_{4}$};
\node[graphnode] (n_B5) at (11.82,-1.72) {$B_{5}$};
