...
\node[graphnode] (n_L) at (-5.75,0.07) {L};
\node[graphnode] (n_l0) at (-3.45,0.07) {l0};
\node[graphnode] (n_l1) at (-4.60,2.06) {l1};
\node[graphnode] (n_l2) at (-6.90,2.06) {l2};
\node[graphnode] (n_l3) at (-8.05,0.07) {l3};
\node[graphnode] (n_l4) at (-6.90,-1.92) {l4};
\node[graphnode] (n_l5) at (-4.60,-1.92) {l5};
\node[graphnode] (n_R) at (5.75,0.07) {R};
\node[graphnode] (n_r0) at (8.05,0.07) {r0};
\node[graphnode] (n_r1) at (6.90,2.06) {r1};
\node[graphnode] (n_r2) at (4.60,2.06) {r2};
\node[graphnode] (n_r3) at (3.45,0.07) {r3};
\node[graphnode] (n_r4) at (4.60,-1.92) {r4};
\node[graphnode] (n_r5) at (6.90,-1.92) {r5};
\node[graphnode] (n_x0) at (-1.15,0.07) {x0};
\node[graphnode] (n_x1) at (1.15,0.07) {x1};
\node[graphnode] (n_y0) at (-8.05,-4.53) {y0};
\node[graphnode] (n_y1) at (8.05,-4.53) {y1};
