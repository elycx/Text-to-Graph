...
\node[graphnode,fill=gray!15] (n_L) at (-4.60,0.05) {L};
\node[graphnode] (n_l0) at (-2.88,0.05) {l0};
\node[graphnode] (n_l1) at (-3.68,1.75) {l1};
\node[graphnode] (n_l2) at (-5.46,1.54) {l2};
\node[graphnode] (n_l3) at (-6.33,0.05) {l3};
\node[graphnode] (n_l4) at (-5.70,-1.67) {l4};
\node[graphnode] (n_l5) at (-3.58,-1.80) {l5};
\node[graphnode,fill=gray!15] (n_R) at (4.60,0.05) {R};
\node[graphnode] (n_r0) at (6.33,0.05) {r0};
\node[graphnode] (n_r1) at (5.46,1.54) {r1};
\node[graphnode] (n_r2) at (3.68,1.75) {r2};
\node[graphnode] (n_r3) at (2.88,0.05) {r3};
\node[graphnode] (n_r4) at (3.58,-1.80) {r4};
\node[graphnode] (n_r5) at (5.70,-1.67) {r5};
\node[graphnode,fill=blue!10] (n_x0) at (-1.73,1.89) {x0};
\node[graphnode,fill=blue!10] (n_x1) at (1.73,1.89) {x1};
\node[graphnode,fill=blue!10] (n_y0) at (-1.38,-5.13) {y0};
\node[graphnode,fill=blue!10] (n_y1) at (1.38,-5.13) {y1};
