...
\node[graphnode] (n_l0) at (-3.91,0.00) {l0};
\node[graphnode] (n_l1) at (-4.76,1.90) {l1};
\node[graphnode] (n_l2) at (-6.67,1.60) {l2};
\node[graphnode] (n_l3) at (-7.59,0.00) {l3};
\node[graphnode] (n_l4) at (-6.67,-1.60) {l4};
\node[graphnode] (n_l5) at (-5.05,-2.21) {l5};
\node[graphnode] (n_R) at (5.75,0.00) {R};
\node[graphnode] (n_r0) at (7.59,0.00) {r0};
\node[graphnode] (n_r1) at (6.67,1.60) {r1};
\node[graphnode] (n_r2) at (4.76,1.90) {r2};
\node[graphnode] (n_r3) at (3.91,0.00) {r3};
\node[graphnode] (n_r4) at (5.05,-2.21) {r4};
\node[graphnode] (n_r5) at (6.67,-1.60) {r5};
\node[graphnode] (n_x0) at (-1.73,3.22) {x0};
\node[graphnode] (n_x1) at (1.73,3.22) {x1};
\node[graphnode] (n_y0) at (-1.73,-3.22) {y0};
\node[graphnode] (n_y1) at (1.73,-3.22) {y1};
