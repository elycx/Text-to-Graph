...
\node[graphnode] (n_U0) at (-5.00,1.50) {$U_0$};
\node[graphnode] (n_U1) at (-3.00,2.50) {$U_1$};
\node[graphnode] (n_U2) at (-1.00,1.50) {$U_2$};
\node[graphnode] (n_V0) at (-5.00,-1.50) {$V_0$};
\node[graphnode] (n_V1) at (-3.00,-2.50) {$V_1$};
\node[graphnode] (n_V2) at (-1.00,-1.50) {$V_2$};
\node[graphnode] (n_r) at (1.20,2.50) {$r$};
\node[graphnode] (n_x0) at (3.50,3.70) {$x_0$};
\node[graphnode] (n_x1) at (3.65,0.06) {$x_1$};
\node[graphnode] (n_x00) at (5.80,4.80) {$x_{00}$};
\node[graphnode] (n_x01) at (5.80,3.20) {$x_{01}$};
\node[graphnode] (n_x10) at (5.80,1.40) {$x_{10}$};
\node[graphnode] (n_x11) at (5.80,-0.20) {$x_{11}$};
