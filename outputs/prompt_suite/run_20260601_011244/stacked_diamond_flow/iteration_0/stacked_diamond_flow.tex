...
\node[graphnode] (n_s) at (-3.15,2.76) {s};
\node[graphnode] (n_t) at (22.15,-2.76) {t};
\node[graphnode] (n_u_0) at (0.88,2.76) {$u_{0}$};
\node[graphnode] (n_v_0) at (0.88,-2.76) {$v_{0}$};
\node[graphnode] (n_a_0) at (-0.51,0.81) {$a_{0}$};
\node[graphnode] (n_b_0) at (2.06,-0.60) {$b_{0}$};
\node[graphnode] (n_u_1) at (6.62,2.76) {$u_{1}$};
\node[graphnode] (n_v_1) at (6.62,-2.76) {$v_{1}$};
\node[graphnode] (n_a_1) at (5.44,0.60) {$a_{1}$};
\node[graphnode] (n_b_1) at (7.81,-0.60) {$b_{1}$};
\node[graphnode] (n_u_2) at (12.38,2.76) {$u_{2}$};
\node[graphnode] (n_v_2) at (12.38,-2.76) {$v_{2}$};
\node[graphnode] (n_a_2) at (11.19,0.60) {$a_{2}$};
\node[graphnode] (n_b_2) at (13.56,-0.60) {$b_{2}$};
\node[graphnode] (n_u_3) at (18.12,2.76) {$u_{3}$};
\node[graphnode] (n_v_3) at (18.12,-2.76) {$v_{3}$};
\node[graphnode] (n_a_3) at (16.94,0.60) {$a_{3}$};
\node[graphnode] (n_b_3) at (19.50,-0.81) {$b_{3}$};
