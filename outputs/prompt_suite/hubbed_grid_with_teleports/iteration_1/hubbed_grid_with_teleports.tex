...
\node[graphnode,fill=gray!15] (n_H) at (3.00,6.90) {H};
...
\draw[undirected] (n_H) to[out=180,in=180,looseness=1.55] (n_g21);
\draw[undirected] (n_H) to[out=0,in=0,looseness=1.55] (n_g22);
\draw[undirected] (n_g00) to[out=180,in=-90,looseness=1.5] (n_g23);
\draw[undirected] (n_g03) to[out=0,in=180,looseness=1.8] (n_g20);
\draw[undirected] (n_g10) to[out=-90,in=-90,looseness=2.0] (n_g13);
\draw[undirected] (n_g01) to[out=180,in=-90,looseness=1.4] (n_g22);
\end{tikzpicture}
\end{document}
