...
\node[graphnode] (n_A0) at (-0.84,0.63) {$A_{0}$};
\node[graphnode] (n_A1) at (2.03,0.63) {$A_{1}$};
\node[graphnode] (n_A2) at (4.91,0.63) {$A_{2}$};
\node[graphnode] (n_A3) at (7.78,0.63) {$A_{3}$};
\node[graphnode] (n_A4) at (10.66,0.63) {$A_{4}$};
\node[graphnode] (n_A5) at (13.53,0.63) {$A_{5}$};
\node[graphnode] (n_B0) at (-1.27,-0.95) {$B_{0}$};
\node[graphnode] (n_B1) at (1.61,-0.95) {$B_{1}$};
\node[graphnode] (n_B2) at (4.48,-0.95) {$B_{2}$};
\node[graphnode] (n_B3) at (7.36,-0.95) {$B_{3}$};
\node[graphnode] (n_B4) at (10.23,-0.95) {$B_{4}$};
\node[graphnode] (n_B5) at (13.11,-0.95) {$B_{5}$};
\node[graphnode] (n_S) at (-3.09,0.00) {S};
\node[graphnode] (n_T) at (15.21,0.00) {T};
