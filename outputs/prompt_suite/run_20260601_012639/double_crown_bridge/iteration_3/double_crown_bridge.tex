...
\node[graphnode] (n_L) at (-9.20,0.00) {L};
\node[graphnode] (n_l0) at (-6.33,0.00) {l0};
\node[graphnode] (n_l1) at (-7.74,2.57) {l1};
\node[graphnode] (n_l2) at (-10.64,2.49) {l2};
\node[graphnode] (n_l3) at (-12.07,0.00) {l3};
\node[graphnode] (n_l4) at (-10.64,-2.49) {l4};
\node[graphnode] (n_l5) at (-8.09,-3.10) {l5};
\node[graphnode] (n_R) at (9.20,0.00) {R};
\node[graphnode] (n_r0) at (12.07,0.00) {r0};
\node[graphnode] (n_r1) at (10.64,2.49) {r1};
\node[graphnode] (n_r2) at (7.74,2.57) {r2};
\node[graphnode] (n_r3) at (6.33,0.00) {r3};
\node[graphnode] (n_r4) at (8.09,-3.10) {r4};
\node[graphnode] (n_r5) at (10.64,-2.49) {r5};
\node[graphnode] (n_x0) at (-3.68,4.83) {x0};
\node[graphnode] (n_x1) at (3.68,4.83) {x1};
\node[graphnode] (n_y0) at (-3.68,-4.83) {y0};
\node[graphnode] (n_y1) at (3.68,-4.83) {y1};
